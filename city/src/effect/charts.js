...
export function Temperature(option,scene, TP_value) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const signChart=echarts.init(div);
        ...
        signChart.on('finished',function () {
            var spriteMap = new THREE.TextureLoader().load(signChart.getDataURL() );
